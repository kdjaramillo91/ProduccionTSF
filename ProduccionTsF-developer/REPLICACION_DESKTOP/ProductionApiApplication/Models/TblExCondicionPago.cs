...
namespace ProductionApiApplication.Models
{
    ...
    public partial class TblExCondicionPago
    {
        public string CCiIdExCondicionPago { get; set; }
        public string CNoExCondicionPago { get; set; }
        public string CCeExCondicionPago { get; set; }
