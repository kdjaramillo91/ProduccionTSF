...
namespace ProductionApiApplication.Models
{
    ...
    public partial class TblOcCabFleteDistribucionImp
    {
        ...
        public int NNuDistribucion { get; set; }
        public decimal NNuOrdenCompra { get; set; }
        public System.DateTime DFxDistribucion { get; set; }
        public string CCeDistribucion { get; set; }
        public Nullable<decimal> NVtFlete { get; set; }
        ...
        public string CCtCalculoDistribucion { get; set; }
    }
}
