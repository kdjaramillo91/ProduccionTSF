...
namespace ProductionApiApplication.Models
{
    ...
    public partial class TblIvDetKardex
    {
        ...
        public Nullable<decimal> NQnCantMvto { get; set; }
        public Nullable<decimal> NQnSaldoCantidad { get; set; }
        public Nullable<decimal> NVtValorMvto { get; set; }
        public Nullable<decimal> NVtSaldoValor { get; set; }
    }
}
