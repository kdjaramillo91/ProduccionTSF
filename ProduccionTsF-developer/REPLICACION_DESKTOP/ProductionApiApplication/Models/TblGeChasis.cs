...
namespace ProductionApiApplication.Models
{
    ...
    public partial class TblGeChasis
    {
        public int NIdGeChasis { get; set; }
        public string CCiChasis { get; set; }
        public string CNoChasis { get; set; }
        public string CNuChasis { get; set; }
        public string CCeChasis { get; set; }
