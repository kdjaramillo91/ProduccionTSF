...
namespace ProductionApiApplication.Models
{
    ...
    public partial class TblCiCabClaveContingencia
    {
        public int NIdCiClaveContingencia { get; set; }
        public string CCiCia { get; set; }
        public int NNuSecImportacion { get; set; }
        public string CCeClaveContingencia { get; set; }
