...
namespace ProductionApiApplication.Models
{
    ...
    public partial class TBLFaCabFacturaExtSeguro
    {
        ...
        public string CDsReferencia5 { get; set; }
        public Nullable<int> NIdControlCarga { get; set; }
        public string CCiIdentFactura { get; set; }
    }
}
