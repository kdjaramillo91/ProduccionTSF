...
namespace ProductionApiApplication.Models
{
    ...
    public partial class TblCiPrCtblConfiguracion
    {
        public string CCiCia { get; set; }
        public string CCiDivision { get; set; }
        public string CCiSucursal { get; set; }
        public string CCiTipoDatoPresDefinitivo { get; set; }
        public string CCiTipoDatoPresMaestro { get; set; }
        public string CCiTipoDatoPresConsumo { get; set; }
        public string CCiTipoComprobanteMaestro { get; set; }
        public string CCiTipoComprobanteConsumo { get; set; }
