...
namespace ProductionApiApplication.Models
{
    ...
    public partial class TblBcBancoTransf
    {
        public string CCiBanco { get; set; }
        public string CCiBancoProveedor { get; set; }
        public string CCiBancoTransf { get; set; }
        public string CNoBancoTransf { get; set; }
        public string CCeBancoTransf { get; set; }
        ...
        public virtual TblCiBancos TblCiBancos { get; set; }
    }
}
