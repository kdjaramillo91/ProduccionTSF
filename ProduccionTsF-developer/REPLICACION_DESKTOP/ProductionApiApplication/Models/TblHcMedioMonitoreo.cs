...
namespace ProductionApiApplication.Models
{
    ...
    public partial class TblHcMedioMonitoreo
    {
        public int NIdHcMedioMonitoreo { get; set; }
        public string CCiMedioMonitoreo { get; set; }
        public string CNoMedioMonitoreo { get; set; }
        public string CCeMedioMonitoreo { get; set; }
