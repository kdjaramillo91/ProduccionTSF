...
namespace ProductionApiApplication.Models
{
    ...
    public partial class TblGeCategoriaProducto
    {
        public short NIdGeCategoriaProducto { get; set; }
        public string CCiCategoriaProducto { get; set; }
        public string CNoCategoriaProducto { get; set; }
        public string CCeCategoriaProducto { get; set; }
        public string CSNAfectaRatio { get; set; }
        public string CSNIngresoManualFactura { get; set; }
