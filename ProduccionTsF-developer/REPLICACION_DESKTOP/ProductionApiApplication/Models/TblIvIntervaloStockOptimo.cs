...
namespace ProductionApiApplication.Models
{
    ...
    public partial class TblIvIntervaloStockOptimo
    {
        public string CCiIntervalo { get; set; }
        public string CNoIntervalo { get; set; }
        public short NNuMesInicio { get; set; }
        public short NNuMesFin { get; set; }
        public string CCeIntervalo { get; set; }
