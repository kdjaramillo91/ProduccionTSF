...
namespace ProductionApiApplication.Models
{
    ...
    public partial class TblExDespachaAduana
    {
        public string CCiIdExDespachaAduana { get; set; }
        public string CNoExDespachaAduana { get; set; }
        public Nullable<decimal> NNuValorBase { get; set; }
        public Nullable<decimal> NNuValorAdicional { get; set; }
        public string CCeExDespachaAduana { get; set; }
