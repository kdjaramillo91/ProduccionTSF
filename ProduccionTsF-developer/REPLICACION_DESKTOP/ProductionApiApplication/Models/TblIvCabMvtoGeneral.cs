...
namespace ProductionApiApplication.Models
{
    ...
    public partial class TblIvCabMvtoGeneral
    {
        ...
        public Nullable<int> NNuFaOrdenProduccion { get; set; }
        public Nullable<int> NIdNoEmpleado { get; set; }
        public Nullable<int> NNuEntregaPedido { get; set; }
        public string CciCliente { get; set; }
        public Nullable<int> NIdControlOrigen { get; set; }
        public string CCtPrograma { get; set; }
        public string CSnMuestraPresupuesto { get; set; }
