...
namespace ProductionApiApplication.Models
{
    ...
    public partial class TblExGrupoServicio
    {
        public string CCiGrupoServicio { get; set; }
        public string CNoGrupoServicio { get; set; }
        public short NNuOrden { get; set; }
        public string CCtGrupoServicio { get; set; }
        public string CCeGrupoServicio { get; set; }
