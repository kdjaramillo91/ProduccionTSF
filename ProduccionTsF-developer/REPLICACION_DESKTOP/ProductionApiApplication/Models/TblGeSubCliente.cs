...
namespace ProductionApiApplication.Models
{
    ...
    public partial class TblGeSubCliente
    {
        public short NIdSubCliente { get; set; }
        public string CCiSubCliente { get; set; }
        public string CDsSubCliente { get; set; }
        public string CDsDireccion { get; set; }
        public string CDsObservacion { get; set; }
        public string CCeSubCliente { get; set; }
