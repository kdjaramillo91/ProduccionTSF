...
namespace ProductionApiApplication.Models
{
    ...
    public partial class TBLFaDetNotaEntrega
    {
        ...
        public Nullable<int> NnuCantProducto { get; set; }
        public string CNoDiametro { get; set; }
        public string CnoReferencia { get; set; }
        public string CNoLongitud { get; set; }
        public string CNoEspesor { get; set; }
    
        public virtual TBLFaCabNotaEntrega TBLFaCabNotaEntrega { get; set; }
    }
}
