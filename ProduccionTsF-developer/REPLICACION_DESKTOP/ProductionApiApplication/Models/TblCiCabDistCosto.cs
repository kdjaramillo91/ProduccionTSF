...
namespace ProductionApiApplication.Models
{
    ...
    public partial class TblCiCabDistCosto
    {
        ...
        public Nullable<decimal> NnuTotOrigen { get; set; }
        public Nullable<decimal> NnuTotDestino { get; set; }
        public Nullable<decimal> NnuTotContra { get; set; }
