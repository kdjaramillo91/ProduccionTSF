...
values ('Requerido Contacto Cliente Exterior', 'REQCCEXT','SI',1,5,1,1,1,GETDATE(),1,GETDATE(),'');


-- OTRAS IMPLEMENTACIONES
insert into Setting(name,code,value,id_settingDataType,id_module,id_company,isActive,id_userCreate,dateCreate, id_userUpdate, dateUpdate,description)
values ('Requerido Contacto Cliente Exterior', 'REQCCEXT','NO',1,5,1,1,1,GETDATE(),1,GETDATE(),'');
