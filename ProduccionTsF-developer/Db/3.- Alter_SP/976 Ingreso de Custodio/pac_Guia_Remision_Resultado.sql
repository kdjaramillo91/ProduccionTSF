...
and (doc.[id_documentState] = case when @id_docState = 0 then doc.[id_documentState] else @id_docState end
     OR
	 doc.[id_documentState] = case when @id_docState_2 = 0 then doc.[id_documentState] else @id_docState_2 end
)
...
and doc.accessKey like '%'+@str_accesKey+'%'
and doc.authorizationNumber like '%'+@str_authNumber+'%'
...
[pac_Guia_Remision_Resultado]'<RGQ id_docState="0" str_numberDoc="" str_referenceDoc="" str_startEmissionDate="" str_endEmissionDate="" str_startAuthDate="" str_endAuthDate="" str_accesKey="" str_authNumber="" 
