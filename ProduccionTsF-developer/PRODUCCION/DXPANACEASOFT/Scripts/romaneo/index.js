...
function SearchClick() {
    ...
    var data = {
        ...
        secTransaccional: TextBoxSecTransaccional.GetText(),
        id_typeRomaneo: ComboBoxTypeRomaneoIndex.GetValue(),
    }
    
    showPartialPage($("#grid"), 'Romaneo/SearchResult', data);
}
...
function ClearClick() {
    ...
    TextBoxSecTransaccional.SetText(null);
    ComboBoxTypeRomaneoIndex.SetValue(null);
}
