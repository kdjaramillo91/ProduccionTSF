...
function Update(approve) {
    var valid = ASPxClientEdit.ValidateEditorsInContainer(null, "tabdetail", true);
     ...
     if (valid) {
         ...
         var data = "id=" + id + "&" + "approve=" + approve + "&" + $("#FormEditCity").serialize();
         var url = (id === "0") ? "City/CityPartialAddNew"
                               : "City/CityPartialUpdate";
...
function CancelDocument(s, e) {
    showConfirmationDialog(function () {
        ...
        showForm("City/Cancel", data);
    }, "¿Desea anular el Ciudad?");
}
