...
function Update(approve) {
    // 
    var valid = ASPxClientEdit.ValidateEditorsInContainer("tabRemissionGuideRiver",null, true);
    ...
    if (valid && validT && valid2) {
        // 
        //var id = $("#id_RemissionGuideRiver").val();

        var id = document.getElementById("id_remissionGuideRiver").getAttribute("idremissionGuideRiver");

        var data = "id=" + id + "&" + "approve=" + approve + "&" + "exitTimeBuilding=" + exitTimePlantProductionTmp + "&" + $("#formEditRemissionGuideRiverControlVehicle").serialize();
        var url = (id === "0") ? "RemissionGuideRiverControlVehicle/RemissionGuideRiverControlVehiclePartialAddNew"
                               : "RemissionGuideRiverControlVehicle/RemissionGuideRiverControlVehiclePartialUpdate";
...
function ButtonCancel_Click(s, e) {
    ...
    showPage("RemissionGuideRiverControlVehicle/Index", null);
}
...
function Remove(s, e) {
    ...
    activeGridView.GetSelectedFieldValues(key, function (values) {
        ...
        var url = "RemissionGuideRiverControlVehicle/DeleteSelectedRemissionGuideRiverControlVehicleDetails";
...
function UpdateView() {
    //var id = parseInt($("#id_RemissionGuideRiver").val());
    ...
    //$.ajax({
    //    url: "RemissionGuideRiverControlVehicle/Actions",
    //    type: "post",
    //    data: { id: id },
    //    async: true,
    //    cache: false,
...
function UpdatePagination() {
    var current_page = 1;
    $.ajax({
        url: "RemissionGuideRiverControlVehicle/InitializePagination",
        type: "post",
        data: { id_RemissionGuideRiver: $("#id_remissionGuideRiver").val() },
        async: false,
        cache: false,
        error: function (error) {
            console.log(error);
