...
function ButtonCancel_Click(s, e) {
    ...
    if (gvBoxCardAndBank !== null && gvBoxCardAndBank !== undefined) {
        gvBoxCardAndBank.CancelEdit();
    }
}
...
function CancelDocument(s, e) {
    showConfirmationDialog(function () {
        var data = {
            id: $("#id_BoxCardAndBank").val()
        };
        showForm("BoxCardAndBank/Cancel", data);
...
function RevertDocument(s, e) {
    showConfirmationDialog(function () {
        ...
        showForm("BoxCardAndBank/Revert", data);
    }, "¿Desea Activar?");
}
