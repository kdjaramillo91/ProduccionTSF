...
function Update(approve) {
   ...
   // var validT = ASPxClientEdit.ValidateEditorsInContainer("RGCVContainer", null, true);
    ...
    if (valid  && valid2) {
        ...
        var data = "id=" + id + "&" + "approve=" + approve + "&" + $("#formEditRemissionGuideRiverInternControlViatic").serialize();
        var url = "RemissionGuideRiverInternControlViatic/RemissionGuideRiverInternControlViaticPartialUpdate";
...
function ButtonCancel_Click(s, e) {
    ...
    showPage("RemissionGuideRiverInternControlViatic/Index", null);
}
...
function Remove(s, e) {
    ...
    activeGridView.GetSelectedFieldValues(key, function (values) {
        ...
        var url = "RemissionGuideRiverInternControlViatic/DeleteSelectedRemissionGuideRiverControlVehicleDetails";
...
function UpdatePagination() {
    var current_page = 1;
    $.ajax({
        url: "RemissionGuideRiverInternControlViatic/InitializePagination",
        type: "post",
