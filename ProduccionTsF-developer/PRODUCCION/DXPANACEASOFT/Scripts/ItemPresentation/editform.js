...
function Update(approve) {
    var valid = ASPxClientEdit.ValidateEditorsInContainer(null, "tabdetail", true);
     ...
     if (valid) {
         ...
         var id = $("#id_Presentation").val();
   
         
      
         var data = "id=" + id + "&" + "approve=" + approve + "&" + $("#FormEditPresentation").serialize();
         var url = (id === "0") ? "ItemPresentation/PresentationPartialAddNew"
                               : "ItemPresentation/PresentationPartialUpdate";
...
function CancelDocument(s, e) {
    showConfirmationDialog(function () {
        var data = {
            id: $("#id_Presentation").val()
        };
        showForm("ItemPresentation/Cancel", data);
    }, "¿Desea anular la Presentacion?");
}
...
function RevertDocument(s, e) {
    showConfirmationDialog(function () {
        ...
        showForm("ItemPresentation/Revert", data);
    }, "¿Desea Activar?");
}
