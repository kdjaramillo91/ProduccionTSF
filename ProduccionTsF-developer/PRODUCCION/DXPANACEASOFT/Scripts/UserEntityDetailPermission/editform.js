...
function Update(approve) {
    ...
    if (valid) {
        // 
        id_entity: $("#id_entityValue").val()
        gvUserEntityDetail.UpdateEdit();
    }
...
function ButtonUpdate_Click(s, e) {
    var usuario = $("#id_user_I").val()
    var bodega = $("#id_warehouseEntityDetail_I").val()
    ...
    if (data != null) {
        $.ajax({
            url: "UserEntityDetailPermission/UserEntityDetailPermissionPartialAddNew",
            type: "post",
            data: { id_user: usuario, entity: bodega },
            async: true,
            cache: false,
...
function RedirecBack() {
    showPage("UserEntityDetailPermission/Index");
}
...
function CancelDocument(s, e) {
    showConfirmationDialog(function () {
        ...
        showForm("UserEntityDetailPermission/Cancel", data);
...
function RevertDocument(s, e) {
    showConfirmationDialog(function () {
        ...
        showForm("CategoryCustomerType/Revert", data);
    }, "¿Desea Activar?");
}
