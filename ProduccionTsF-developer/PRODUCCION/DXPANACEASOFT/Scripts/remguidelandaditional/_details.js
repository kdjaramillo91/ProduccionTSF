...
function ItemCombo_OnInit(s, e) {
    ...
    $.ajax({
        url: "RemGuideLandAditional/PurchaseOrderDetails",
        type: "post",
        data: data,
        async: false,
        cache: false,
...
function DetailsUpdateItemInfo(data) {
    ...
    if (data.id_item != null) {
        ...
        $.ajax({
            url: "RemGuideLandAditional/ItemDetailData",
            type: "post",
            data: data,
            async: true,
            cache: false,
...
function DetailsBusinessOportunityPlanningDetailCombo_Init(s, e) {
    ...
    $.ajax({
        url: "RemGuideLandAditional/BusinessOportunityPlanningDetailData",
        type: "post",
        data: data,
        async: false,
        cache: false,
...
function OnItemValidation(s, e) {
    ...
    if (s.GetValue() === null) {
        ...
        if (data.id_itemNew != id_itemIniAux) {
            $.ajax({
                url: "RemGuideLandAditional/ItsRepeatedItemDetail",
                type: "post",
                data: data,
                async: false,
                cache: false,
...
function OnQuantityProgrammedValidation(s, e) {
    ...
    //    e.isValid = false;
    //    e.errorText = "Valor Incorrecto";
    //} else if (quantityOrdered.GetValue() !== 0) {
    //    if (quantityOrdered.GetValue() < e.value) {
    //        e.isValid = false;
    //        e.errorText = "La cantidad programada no puede ser mayor a la ordenada";
    //    }
    //}
}
