...
function Update(approve) {
    ...
    if (valid) {
        gvAdvanceParameters.UpdateEdit();
    }
...
function ButtonCancel_Click(s, e) {
    ...
    if (gvAdvanceParameters !== null && gvAdvanceParameters !== undefined) {
        gvAdvanceParameters.CancelEdit();
    }
}
...
function CancelDocument(s, e) {
    showConfirmationDialog(function () {
        var data = {
            id: $("#id_AdvanceParameters").val()
        };
        showForm("AdvanceParameters/Cancel", data);
...
function RevertDocument(s, e) {
    showConfirmationDialog(function () {
        ...
        showForm("AdvanceParameters/Revert", data);
    }, "¿Desea Activar?");
}
