...
function OnProviderIceThirdValidation(s, e) {
    if (!isOwn.GetChecked()) {
        e.isValid = true;
        return;
    }
...
function OnVehicleValidation(s, e) {
    ...
    if (e.value != null) {
        ...
        if (id_vehicle.GetValue() != null && id_vehicle.GetValue() != undefined) {
            $.ajax({
                url: "Logistics/ValidateVehicleAnotherRemissionGuideProviderCompany",
                type: "post",
                async: false,
                cache: false,
                data: {
...
function OnSecuritySealNumberValidation(s, e) {
    ...
    if (e.value === null) {
        ...
        $.ajax({
            url: "Logistics/ValidateSecuritySealNumber",
            type: "post",
            async: false,
            cache: false,
            data: {
...
function OnAssigendPersonValidation(s, e) {
    ...
    if (e.value === null) {
        ...
        $.ajax({
            url: "Logistics/ValidateAssigendPersonValidation",
            type: "post",
            async: false,
            cache: false,
            data: {
