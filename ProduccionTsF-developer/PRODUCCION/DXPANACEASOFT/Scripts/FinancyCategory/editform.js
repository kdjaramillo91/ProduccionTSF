...
function ButtonCancel_Click(s, e) {
    ...
    if (gvFinancyCategory !== null && gvFinancyCategory !== undefined) {
        gvFinancyCategory.CancelEdit();
    }
}
...
function CancelDocument(s, e) {
    showConfirmationDialog(function () {
        var data = {
            id: $("#id_FinancyCategory").val()
        };
        showForm("FinancyCategory/Cancel", data);
...
function RevertDocument(s, e) {
    showConfirmationDialog(function () {
        ...
        showForm("FinancyCategory/Revert", data);
    }, "¿Desea Activar?");
}
