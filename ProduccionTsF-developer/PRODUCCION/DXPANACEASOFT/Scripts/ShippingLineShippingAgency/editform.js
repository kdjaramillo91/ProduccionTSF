...
function Update(approve) {
    ...
    if (valid) {
        gvShippingLineShippingAgency.UpdateEdit();
    }
...
function ButtonCancel_Click(s, e) {
    ...
    if (gvShippingLineShippingAgency !== null && gvShippingLineShippingAgency !== undefined) {
        gvShippingLineShippingAgency.CancelEdit();
    }
}
...
function CancelDocument(s, e) {
    showConfirmationDialog(function () {
        ...
        showForm("ShippingLineShippingAgency/Cancel", data);
...
function RevertDocument(s, e) {
    showConfirmationDialog(function () {
        ...
        showForm("ShippingLineShippingAgency/Revert", data);
    }, "¿Desea Activar?");
}
