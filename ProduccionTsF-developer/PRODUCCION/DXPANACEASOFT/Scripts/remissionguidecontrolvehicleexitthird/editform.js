...
function Update(approve) {
    ...
    if (valid && validT && valid2) {
        ...
        var data = "id=" + id + "&" + "approve=" + approve + "&" 
                            + "exitTimeBuilding=" + exitTimePlantProductionTmp + "&" 
                            + $("#formEditRemissionGuideControlVehicleExitThird").serialize();
        var url = (id === "0" || id === 0) ? "RemissionGuideControlVehicleExitThird/RemissionGuideControlVehicleExitThirdPartialAddNew"
                               : "RemissionGuideControlVehicleExitThird/RemissionGuideControlVehicleExitThirdPartialUpdate";
...
function ButtonCancel_Click(s, e) {
    ...
    showPage("RemissionGuideControlVehicleExitThird/Index", null);
}
...
function Remove(s, e) {
    ...
    activeGridView.GetSelectedFieldValues(key, function (values) {
        ...
        var url = "RemissionGuideControlVehicleExitThird/DeleteSelectedRemissionGuideControlVehicleExitThirdDetails";
...
function exitDateProductionBuildingOnInit(s, e) {
    var entrancedTmp = document.getElementById("exitdpb").value;
...
function UpdatePagination() {
    var current_page = 1;
    $.ajax({
        url: "RemissionGuideControlVehicleExitThird/InitializePagination",
        type: "post",
