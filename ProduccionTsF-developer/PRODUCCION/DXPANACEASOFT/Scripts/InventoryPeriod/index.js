...
function btnSearch_click() {
    ...
    var data = $("#formFilterInventoryPeriod").serialize() + "&anio=" + year.GetValue() + "&id_InventoryPeriodType=" + id_PeriodType.GetValue();
      if (data != null) {
        $.ajax({
            url: "InventoryPeriod/InventoryPeriodResults",
            type: "post",
            data: data,
            async: true,
            cache: false,
