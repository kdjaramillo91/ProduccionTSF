...
function OnClickSearchReceptionDispatchMaterials() {
    var data = $("#ReceptionDispatchMaterialsFilterForm").serialize();

    if (data != null) {
        $.ajax({
            url: "ReceptionDispatchMaterials/ReceptionDispatchMaterialsResultsPartial",
            type: "post",
            data: data,
            async: true,
            cache: false,
...
function OnClickClearFiltersReceptionDispatchMaterials() {
...
function UpdateTitlePanel() {
    ...
    var text = "Total de elementos seleccionados: <b>" + gvReceptionDispatchMaterials.GetSelectedRowCount() + "</b>";
    var hiddenSelectedRowCount = gvReceptionDispatchMaterials.GetSelectedRowCount() - selectedFilteredRowCount;
    ...
    //if ($("#selectAllMode").val() != "AllPages") {
    SetElementVisibility("lnkSelectAllRows", gvReceptionDispatchMaterials.GetSelectedRowCount() > 0 && gvReceptionDispatchMaterials.cpVisibleRowCount > selectedFilteredRowCount);
    SetElementVisibility("lnkClearSelection", gvReceptionDispatchMaterials.GetSelectedRowCount() > 0);
    //}
...
function GetSelectedFilteredRowCount() {
    return gvReceptionDispatchMaterials.cpFilteredRowCountWithoutPage + gvReceptionDispatchMaterials.GetSelectedKeysOnPage().length;
}
...
function gvResultsClearSelection() {
    gvReceptionDispatchMaterials.UnselectRows();
}

function gvResultsSelectAllRows() {
    gvReceptionDispatchMaterials.SelectRows();
}
...
function OnClickUpdateReceptionDispatchMaterials(s, e) {
    var data = {
        id: gvReceptionDispatchMaterials.GetRowKey(e.visibleIndex)
    };
...
function ReceptionDispatchMaterialsDetails_BeginCallback(s, e) {
    e.customArgs["id_receptionDispatchMaterials"] = s.cpIdReceptionDispatchMaterials;
}
