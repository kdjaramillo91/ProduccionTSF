...
function Update(approve) {
    // 
    var valid = ASPxClientEdit.ValidateEditorsInContainer(null, "tabRemissionGuideRiverControlEntrance", true);
    ...
    if (valid && validT && valid2) {
        ...
        var data = "id=" + id + "&" + "approve=" + approve + "&" + "entranceTimePUP=" + entranceTimeProductionUnitProviderTmp + "&"
                            ...
                            + $("#formEditRemissionGuideRiverControlVehicleEntrance").serialize();
        var url = (id === "0" || id === 0) ? "RemissionGuideRiverControlVehicleEntrance/RemissionGuideRiverControlVehicleEntrancePartialAddNew"
                               : "RemissionGuideRiverControlVehicleEntrance/RemissionGuideRiverControlVehicleEntrancePartialUpdate";
...
function ButtonCancel_Click(s, e) {
    ...
    showPage("RemissionGuideRiverControlVehicleEntrance/Index", null);
}
...
function Remove(s, e) {
    ...
    activeGridView.GetSelectedFieldValues(key, function (values) {
        ...
        var url = "RemissionGuideRiverControlVehicleEntrance/DeleteSelectedRemissionGuideRiverControlVehicleEntranceDetails";
...
function UpdatePagination() {
    var current_page = 1;
    $.ajax({
        url: "RemissionGuideRiverControlVehicleEntrance/InitializePagination",
        type: "post",
