...
function Update(approve) {
   ...
   // var validT = ASPxClientEdit.ValidateEditorsInContainer("RGCVContainer", null, true);
    ...
    if (valid  && valid2) {
        ...
        var data = "id=" + id + "&" + "approve=" + approve + "&" + $("#formEditRemissionGuideRiverInternControl").serialize();
        var url = "RemissionGuideRiverInternControl/RemissionGuideRiverInternControlPartialUpdate";
...
function ButtonCancel_Click(s, e) {
    ...
    showPage("RemissionGuideRiverInternControl/Index", null);
}
...
function Remove(s, e) {
    ...
    activeGridView.GetSelectedFieldValues(key, function (values) {
        ...
        var url = "RemissionGuideRiverInternControl/DeleteSelectedRemissionGuideRiverControlVehicleDetails";
...
function UpdatePagination() {
    var current_page = 1;
    $.ajax({
        url: "RemissionGuideRiverInternControl/InitializePagination",
        type: "post",
