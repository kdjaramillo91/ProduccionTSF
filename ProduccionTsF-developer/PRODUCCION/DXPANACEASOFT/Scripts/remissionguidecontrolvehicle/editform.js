...
function Update(approve) {
    ...
    if (valid && validT && valid2) {
        ...
        var data = "id=" + id + "&" + "approve=" + approve + "&" + "exitTimeBuilding=" + exitTimePlantProductionTmp + "&" + $("#formEditRemissionGuideControlVehicle").serialize();
        var url = (id === "0") ? "RemissionGuideControlVehicle/RemissionGuideControlVehiclePartialAddNew"
                               : "RemissionGuideControlVehicle/RemissionGuideControlVehiclePartialUpdate";
...
function ButtonCancel_Click(s, e) {
    ...
    showPage("RemissionGuideControlVehicle/Index", null);
}
...
function Remove(s, e) {
    ...
    activeGridView.GetSelectedFieldValues(key, function (values) {
        ...
        var url = "RemissionGuideControlVehicle/DeleteSelectedRemissionGuideControlVehicleDetails";
...
function UpdatePagination() {
    var current_page = 1;
    $.ajax({
        url: "RemissionGuideControlVehicle/InitializePagination",
        type: "post",
