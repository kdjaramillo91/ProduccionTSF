...
function Update(approve) {
    ...
    if (valid) {
        gvClientCategoryTypeBusiness.UpdateEdit();
    }
...
function ButtonCancel_Click(s, e) {
    if (gvClientCategoryTypeBusiness !== null && gvClientCategoryTypeBusiness !== undefined) {
        gvClientCategoryTypeBusiness.CancelEdit();
    }
}
...
function CancelDocument(s, e) {
    showConfirmationDialog(function () {
        ...
        showForm("ClientCategoryTypeBusiness/Cancel", data);
...
function RevertDocument(s, e) {
    showConfirmationDialog(function () {
        ...
        showForm("ClientCategoryTypeBusiness/Revert", data);
    }, "¿Desea Activar?");
}
