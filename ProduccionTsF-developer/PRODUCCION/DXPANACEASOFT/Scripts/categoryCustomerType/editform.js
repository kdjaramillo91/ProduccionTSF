...
function Update(approve) {
    ...
    if (valid) {
        gvCategoryCustomerType.UpdateEdit();
    }
...
function ButtonCancel_Click(s, e) {
    ...
    if (gvCategoryCustomerType !== null && gvCategoryCustomerType !== undefined) {
        gvCategoryCustomerType.CancelEdit();
    }
}
...
function CancelDocument(s, e) {
    showConfirmationDialog(function () {
        ...
        showForm("CategoryCustomerType/Cancel", data);
