...
function Update(approve) {
   ...
   // var validT = ASPxClientEdit.ValidateEditorsInContainer("RGCVContainer", null, true);
    ...
    if (valid  && valid2) {
        ...
        var data = "id=" + id + "&" + "approve=" + approve + "&" + $("#formEditRemissionGuideInternControlViatic").serialize();
        var url = "RemissionGuideInternControlViatic/RemissionGuideInternControlViaticPartialUpdate";
...
function ButtonCancel_Click(s, e) {
    ...
    showPage("RemissionGuideInternControlViatic/Index", null);
}
...
function Remove(s, e) {
    ...
    activeGridView.GetSelectedFieldValues(key, function (values) {
        ...
        var url = "RemissionGuideInternControlViatic/DeleteSelectedRemissionGuideControlVehicleDetails";
...
function UpdatePagination() {
    var current_page = 1;
    $.ajax({
        url: "RemissionGuideInternControlViatic/InitializePagination",
        type: "post",
