...
function Update(approve) {
    ...
    //     var url = (id === "0") ? "PaymentTerm/PaymentTermPartialAddNew"
    //                           : "PaymentTerm/PaymentTermPartialUpdate";
...
function ButtonCancel_Click(s, e) {
    ...
    if (gvPaymentTerm !== null && gvPaymentTerm !== undefined) {
        gvPaymentTerm.CancelEdit();
    }
}
...
function CancelDocument(s, e) {
    showConfirmationDialog(function () {
        var data = {
            id: $("#id_PaymentTerm").val()
        };
        showForm("PaymentTerm/Cancel", data);
...
function RevertDocument(s, e) {
    showConfirmationDialog(function () {
        ...
        showForm("PaymentTerm/Revert", data);
    }, "¿Desea Activar?");
}
...
function UpdateView() {
    //var id = parseInt($("#id_PaymentTerm").val());
