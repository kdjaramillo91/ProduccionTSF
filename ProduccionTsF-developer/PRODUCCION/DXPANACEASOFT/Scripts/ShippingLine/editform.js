...
function Update(approve) {
    ...
    //     var url = (id === "0") ? "ShippingLine/ShippingLinePartialAddNew"
    //                           : "ShippingLine/ShippingLinePartialUpdate";
...
function ButtonCancel_Click(s, e) {
    ...
    if (gvShippingLine !== null && gvShippingLine !== undefined) {
        gvShippingLine.CancelEdit();
    }
}
...
function CancelDocument(s, e) {
    showConfirmationDialog(function () {
        var data = {
            id: $("#id_ShippingLine").val()
        };
        showForm("ShippingLine/Cancel", data);
...
function RevertDocument(s, e) {
    showConfirmationDialog(function () {
        ...
        showForm("ShippingLine/Revert", data);
    }, "¿Desea Activar?");
}
...
function UpdateView() {
    //var id = parseInt($("#id_ShippingLine").val());
