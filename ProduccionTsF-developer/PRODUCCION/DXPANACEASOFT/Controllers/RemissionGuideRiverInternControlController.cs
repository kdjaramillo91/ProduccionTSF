...
{
    [Authorize]
    public class RemissionGuideRiverInternControlController : DefaultController
    {
        // POST: RemissionGuideRiverControlVehicle
        [HttpPost]
        ...
        [HttpPost]
        public ActionResult RemissionGuideRiverInternControlResults(RemissionGuideRiver remissionGuideRiver,
                                          Document document,
                                          ...
                                          int[] items, int[] businessOportunities)
        {
            var model = db.RemissionGuideRiver
                            .Where(w => //w.id_tbsysCatalogState != null
            ...
            return PartialView("_RemissionGuideRiverInternControlResultsPartial", model.OrderByDescending(r => r.id).ToList());
        }
        [HttpPost, ValidateInput(false)]
        public ActionResult RemissionGuideRiverInternControlPartial()
        {
            List<RemissionGuideRiver> model = (List<RemissionGuideRiver>)TempData["model"];
            TempData["model"] = model;
            TempData.Keep("model");
            return PartialView("_RemissionGuideRiverInternControlPartial",model.OrderByDescending(r => r.id).ToList());
        }
        [HttpPost, ValidateInput(false)]
        public ActionResult RemissionGuideRiverResults()
        {
            ...
            && w.RemissionGuideRiverCustomizedAdvancedTransportist.hasPayment != true
            ...
            return PartialView("_RemissionGuideRiverInternControlHeaderResultsPartial", model.OrderByDescending(r => r.id).ToList());
        }
        [HttpPost, ValidateInput(false)]
        public ActionResult RemissionGuideRiverPartial()
        { 
            var model = db.RemissionGuideRiver.Where(w => 
            (w.PurchaseOrderShippingType.code == "T" || w.PurchaseOrderShippingType.code == "M" || w.PurchaseOrderShippingType.code == "TF")
            && (w.Document.DocumentState.code == "03" || w.Document.DocumentState.code == "06")
            && w.RemissionGuideRiverCustomizedAdvancedTransportist.hasPayment != true
            && (w.hasExitPlanctProduction != true && w.hasEntrancePlanctProduction != true)
            && ((w.RemissionGuideRiverAssignedStaff.Where(l => l.viaticPrice > 0).ToList().Count > 0)
        ...
        [HttpPost, ValidateInput(false)]
        public ActionResult RemissionGuideRiverInternControlPartialAddNew(bool approve, string exitTimeBuilding, RemissionGuideRiverControlVehicle itemModel)
        {
        ...
        [HttpPost, ValidateInput(false)]
        public ActionResult RemissionGuideRiverInternControlPartialUpdate(bool approve, string exitTimeBuilding, RemissionGuideRiver itemModel, RemissionGuideRiverCustomizedAdvancedTransportist rgt)
        {
            ...
            if (itemModel != null)
            {
                using (DbContextTransaction trans = db.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        RemissionGuideRiverCustomizedAdvancedTransportist rgcat = rgTmp.RemissionGuideRiverCustomizedAdvancedTransportist;
                        ...
                        db.RemissionGuideRiverCustomizedAdvancedTransportist.Attach(rgcat);
            ...
            return PartialView("_RemissionGuideRiverInternControlMainFormPartial", rgTmp);
        }
        #endregion

        #region "REMISSION GUIDE RIVER CONTROL VEHICLE EDIT FORM"
        [HttpPost, ValidateInput(false)]
        public ActionResult FormEditRemissionGuideRiverInternControl(int id)
        {
            ...
            return PartialView("_FormEditRemissionGuideRiverInternControl", remissionGuideRiver);
        }
        ...
        public ActionResult RemissionGuideRiverControlVehicleDetailViewAssignedStaff()
        {
            ...
            return PartialView("_RemissionGuideRiverInternControlDetailViewAssignedStaffPartial", remissionGuideRiver.RemissionGuideRiverAssignedStaff.ToList());
        }
        [HttpPost, ValidateInput(false)]
        public ActionResult RemissionGuideRiverControlVehicleDetailViewSecuritySeals()
        {
            int id_remissionGuideRiver = (Request.Params["id_remissionGuideRiver"] != null && Request.Params["id_remissionGuideRiver"] != "") ? int.Parse(Request.Params["id_remissionGuideRiver"]) : -1;
            RemissionGuideRiver remissionGuideRiver = db.RemissionGuideRiver.FirstOrDefault(r => r.id == id_remissionGuideRiver);
            return PartialView("_RemissionGuideRiverInternControlDetailViewSecuritySealsPartial", remissionGuideRiver.RemissionGuideRiverSecuritySeal.ToList());
        }
        #endregion
        ...
        public ActionResult Pagination(int page)
        {
            ...
            if (remissionGuideRiver != null)
            {
                ...
                TempData.Keep("remissionGuideRiver");
                return PartialView("_RemissionGuideRiverInternControlMainFormPartial", remissionGuideRiver);
            }

            TempData.Keep("remissionGuideRiver");

            return PartialView("_RemissionGuideRiverInternControlMainFormPartial", new RemissionGuideRiver());
        }
        #endregion
