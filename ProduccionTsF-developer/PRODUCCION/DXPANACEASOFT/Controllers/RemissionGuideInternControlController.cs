...
{
    [Authorize]
    public class RemissionGuideInternControlController : DefaultController
    {
        ...
        [HttpPost]
        public ActionResult RemissionGuideInternControlResults(RemissionGuide remissionGuide,
                                          Document document,
                                          ...
                                          int[] items, int[] businessOportunities)
        {
            var model = db.RemissionGuide
                ...
                w.RemissionGuideCustomizedAdvancedTransportist != null
                && w.RemissionGuideCustomizedAdvancedTransportist.hasPayment == true
                ).ToList();
            ...
            return PartialView("_RemissionGuideInternControlResultsPartial", model.OrderByDescending(r => r.id).ToList());
        }
        [HttpPost, ValidateInput(false)]
        public ActionResult RemissionGuideInternControlPartial()
        {
            List<RemissionGuide> model = (List<RemissionGuide>)TempData["model"];
            TempData["model"] = model;
            TempData.Keep("model");
            return PartialView("_RemissionGuideInternControlPartial",model.OrderByDescending(r => r.id).ToList());
        }
        [HttpPost, ValidateInput(false)]
        public ActionResult RemissionGuideResults()
        {
            ...
            return PartialView("_RemissionGuideInternControlHeaderResultsPartial", model.OrderByDescending(r => r.id).ToList());
        }
        [HttpPost, ValidateInput(false)]
        ...
        [HttpPost, ValidateInput(false)]
        public ActionResult RemissionGuideInternControlPartialAddNew(bool approve, string exitTimeBuilding, RemissionGuideControlVehicle itemModel)
        {
        ...
        [HttpPost, ValidateInput(false)]
        public ActionResult RemissionGuideInternControlPartialUpdate(bool approve, string exitTimeBuilding, RemissionGuide itemModel, RemissionGuideCustomizedAdvancedTransportist rgt)
        {
            ...
            if (itemModel != null)
            {
                using (DbContextTransaction trans = db.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        RemissionGuideCustomizedAdvancedTransportist rgcat = rgTmp.RemissionGuideCustomizedAdvancedTransportist;
                        rgcat.id_PaymentState = rgt?.id_PaymentState;
                        rgcat.hasPayment = true;
                        rgcat.id_UserApproved = ActiveUser.id;
                        rgcat.dateApproved = DateTime.Now;

                        db.RemissionGuideCustomizedAdvancedTransportist.Attach(rgcat);
                        db.Entry(rgcat).State = EntityState.Modified;
                        ...
                        TempData["remissionGuideInternControl"] = rgTmp;

                        TempData.Keep("remissionGuideInternControl");
            ...
            return PartialView("_RemissionGuideInternControlMainFormPartial", rgTmp);
        }
        #endregion

        #region "REMISSION GUIDE CONTROL VEHICLE EDIT FORM"
        [HttpPost, ValidateInput(false)]
        public ActionResult FormEditRemissionGuideInternControl(int id)
        {
            ...
            return PartialView("_FormEditRemissionGuideInternControl", remissionGuide);
        }

        [HttpPost, ValidateInput(false)]
        public ActionResult RemissionGuideInternControlCopy(int id)
        {
            RemissionGuide remissionGuide = db.RemissionGuide.FirstOrDefault(o => o.id == id);
            ...
            return PartialView("_FormEditRemissionGuideInternControl", remissionGuideCopy);
        }
        ...
        public ActionResult RemissionGuideControlVehicleDetailViewAssignedStaff()
        {
            ...
            return PartialView("_RemissionGuideInternControlDetailViewAssignedStaffPartial", remissionGuide.RemissionGuideAssignedStaff.ToList());
        }
        [HttpPost, ValidateInput(false)]
        public ActionResult RemissionGuideControlVehicleDetailViewSecuritySeals()
        {
            int id_remissionGuide = (Request.Params["id_remissionGuide"] != null && Request.Params["id_remissionGuide"] != "") ? int.Parse(Request.Params["id_remissionGuide"]) : -1;
            RemissionGuide remissionGuide = db.RemissionGuide.FirstOrDefault(r => r.id == id_remissionGuide);
            return PartialView("_RemissionGuideInternControlDetailViewSecuritySealsPartial", remissionGuide.RemissionGuideSecuritySeal.ToList());
        }
        #endregion
        ...
        public ActionResult Pagination(int page)
        {
            ...
            if (remissionGuide != null)
            {
                ...
                TempData.Keep("remissionGuide");
                return PartialView("_RemissionGuideInternControlMainFormPartial", remissionGuide);
            }

            TempData.Keep("remissionGuide");

            return PartialView("_RemissionGuideInternControlMainFormPartial", new RemissionGuide());
        }
        #endregion
                                          ...
                                          int[] items)
        {
            ...
            List<ResultRemisionGuideTransportViatic> modelAux = new List<ResultRemisionGuideTransportViatic>();
            modelAux = db.Database.SqlQuery<ResultRemisionGuideTransportViatic>
                    ("exec par_GuideRemisionViaticoTransportistaTerretre @str_FEmisionDateStart, @str_FEmisionDateEnd",
                    new SqlParameter("str_FEmisionDateStart", paramLst[0].Valor),
                    new SqlParameter("str_FEmisionDateEnd", paramLst[1].Valor)
                    ).ToList();

            TempData["modelRemisionGuieTransportViatic"] = modelAux;
