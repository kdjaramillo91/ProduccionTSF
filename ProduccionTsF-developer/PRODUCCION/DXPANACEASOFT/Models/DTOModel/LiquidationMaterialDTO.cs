...
namespace DXPANACEASOFT.Models.DTOModel
{
	public class LiquidationMaterialDTO
	{
		public LiquidationMaterialDTO()
		{
			...
			InventoryMoveDetailDTO = new List<InventoryMoveFromLiquidation>();
		}
		...
		public List<InventoryMoveFromLiquidation> InventoryMoveDetailDTO { get; set; }
	}
	...
	public class InventoryMoveFromLiquidation
	{
		public int idDocumentIM { get; set; }
		public string sequentialIM { get; set; }
		public string nameNatureMoveIM { get; set; }
		public string nameInventoryReasonIM { get; set; }

		public string nameRemissionGuide { get; set; }
	}
}