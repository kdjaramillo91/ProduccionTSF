...
namespace DXPANACEASOFT.Models.DTOModel
{
	...
	public class DrainingTestDTO
	{
		...
		public int numberSampling { get; set; }

		public List<DrainingTestSamplingDTO> DrainingTestSampligDetails { get; set; }
		public ResultProdLotReceptionDetail ReceptionDetail { get; set; }

		public List<DrainingTestDetail> DrainingTestDetails { get; set; }

		public DataTable DrainingTestDetailsInfo { get; set; }
	...
	public class DrainingTestSamplingDTO
	{
		public int order { get; set; }
		public int id { get; set; }
		public decimal capacity { get; set; }
		public int idMetricUnitCapacity { get; set; }
		public string codeMetricUnitCapacity { get; set; }
		public string nameMetricUnitCapacity { get; set; }
		public int idrainingTest { get; set; }
		public int drawersNumber { get; set; }
		public int drawersNumberSamplig { get; set; }
		public decimal poundsDrained { get; set; }
		public decimal poundsAverage { get; set; }
		public decimal poundsProjected { get; set; }

		public decimal poundsTotalProjected { get; set; }

		public decimal[] valuesDrainingTestDetail { get; set; }
	}
