...
namespace DXPANACEASOFT.Models.FE.Xmls.GuiaRemision
{
    public class Destinatario2
    {
        ...
        public Destinatario2(string identificacionDestinatario, string razonSocialDestinatario, string direccionDestinatario,
            string motivoTraslado
            //, string documentoAduaneroUnico, string codigoEstablecimientoDestino, string ruta,
