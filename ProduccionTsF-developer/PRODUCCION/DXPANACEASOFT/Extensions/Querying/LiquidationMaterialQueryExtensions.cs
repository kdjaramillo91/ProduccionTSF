        ...
        public static Expression<Func<LiquidationMaterialSupplies, bool>> GetRequestByFilter(LiquidationMaterialConsultDTO consultar)
        {
            ...
            Expression<Func<LiquidationMaterialSupplies, bool>> expression = s =>
               ...
               (((s.ResultReceptionDispatchMaterial.FirstOrDefault().dateRemissionGuide != null
                                                                                     ? fechaInicioGuia == null || (s.ResultReceptionDispatchMaterial.Any(a => fechaInicioGuia <= DbFunctions.TruncateTime(a.dateRemissionGuide)))
                                                                                     : fechaInicioGuia == null) &&
                                                                                     (s.ResultReceptionDispatchMaterial.FirstOrDefault().dateRemissionGuide != null
                                                                                     ? fechaFinGuia == null || (s.ResultReceptionDispatchMaterial.Any(a => fechaFinGuia >= DbFunctions.TruncateTime(a.dateRemissionGuide)))
                                                                                     : fechaFinGuia == null))) &&
               ((consultar.numeroGuia == null || consultar.numeroGuia == "") || (s.ResultReceptionDispatchMaterial.FirstOrDefault().dateRemissionGuide != null
                                                                                     ? (s.ResultReceptionDispatchMaterial.Any(a => a.numberRemissionGuide.Contains(consultar.numeroGuia)))
                                                                                     : (consultar.numeroGuia == null || consultar.numeroGuia == "")));
