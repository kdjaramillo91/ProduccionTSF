...
GO
/****** Object:  StoredProcedure [dbo].[ReportFCam003]    Script Date: 05/08/2021 1:26:37 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER OFF
GO

ALTER PROCEDURE [dbo].[ReportFCam003]
	@id INT,
...
from	
	...
	-- ReportFCam003 70492, 'ent'
	-- select * from document where id = 70492
	--	select * from InventoryMovePlantTransfer
	--- select * from InventoryMovePlantTransfer
