...
{
    internal class ProformaETAuxiliar
    {
        private const string m_StoredProcedureName = "spPar_ProformaET";
        ...
        {
            var rptProformaPC = new ProformaETDataSet();
            ...
            using (SqlConnection db = sqlConnection)
            {
                ...
                var detailsResult = db.Query<ProformaETModel>(m_StoredProcedureName, queryParameters, commandType: CommandType.StoredProcedure)
                    .ToList();

                foreach (var detailResult in detailsResult)
                {
                    var cabeceraRow = rptProformaPC.CabeceraProformaET.NewCabeceraProformaETRow();
                   ...
                   // cabeceraRow.GlaseoKilos = detailResult.GlaseoKilos;
                    ...
                    cabeceraRow.idconsignatario = detailResult.idconsignatario;                    
                    cabeceraRow.idnotificador = detailResult.idnotificador;                    
                    cabeceraRow.itemMarkedName = detailResult.itemMarkedName;                    
                    cabeceraRow.itemMarkedSize = detailResult.itemMarkedSize;                    
                   ...
                   // cabeceraRow.UsuarioVentas = detailResult.UsuarioVentas;
                    ...
                    rptProformaPC.CabeceraProformaET.AddCabeceraProformaETRow(cabeceraRow);
                }
        ...
        {
            using (var report = new RptProformaET())
            {
