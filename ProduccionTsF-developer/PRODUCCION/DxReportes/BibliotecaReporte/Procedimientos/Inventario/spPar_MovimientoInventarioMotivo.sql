/****** Object:  StoredProcedure [dbo].[spPar_MovimientoInventarioMotivo]    Script Date: 30/05/2023 02:28:49 p. m. ******/
SET ANSI_NULLS ON
GO
...
-- SP/query Original: par_Movimiento_InventarioMotivo
CREATE OR ALTER PROC [dbo].[spPar_MovimientoInventarioMotivo]
	@id int,
	@id_user int
as 
set nocount on 
...
/*
	EXEC spPar_MovimientoInventarioMotivo 
*/
GO