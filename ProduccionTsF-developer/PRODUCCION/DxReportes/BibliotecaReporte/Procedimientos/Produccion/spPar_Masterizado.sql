--exec spPar_Masterizado @id=893674
--exec spPar_Masterizado @id=893674
--exec spPar_Masterizado @id=792309
--exec spPar_Masterizado @id=792312
--exec spPar_Masterizado @id=792312
GO
/****** Object:  StoredProcedure [dbo].[par_Movimiento_InventarioMasterizado]    Script Date: 25/01/2023 15:08:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON 
GO
Create procedure [dbo].[spPar_Masterizado] 
	@id int
as 
set nocount on 
...
com.logo,
com.logo2
,MasteredDetail.id_lotMP
,MasteredDetail.id_productMP as Lote
