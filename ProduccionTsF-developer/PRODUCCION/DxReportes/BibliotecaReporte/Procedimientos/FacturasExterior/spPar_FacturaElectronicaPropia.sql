/****** Object:  StoredProcedure [dbo].[spPar_FacturaElectronicaPropia]    Script Date: 19/06/2023 03:40:55 p. m. ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROC [dbo].[spPar_FacturaElectronicaPropia] --6559     
@id INT      
    AS      
 SET nocount ON    
...
/*
	EXEC spPar_FacturaElectronicaPropia 1134950
*/
