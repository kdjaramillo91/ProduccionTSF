/****** Object:  StoredProcedure [dbo].[spPar_LibrasLiquidadas]    Script Date: 04/04/2023 05:40:14 p. m. ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dbo].[spPar_LibrasLiquidadas]
@id varchar(50) = '',
@fi varchar(10) = '',
@ff varchar(10) = '',
@proveedor int = 0
...
select 
	   ...
	   Company.phoneNumber as telephone_cia,
		CONVERT(VARCHAR, CONVERT(DATETIME, @fi), 103) AS Fi,
		CONVERT(VARCHAR, CONVERT(DATETIME, @ff), 103) AS Ff,
		proceso = PT.[name],
...
/*
	EXEC spPar_LibrasLiquidadas @id=N'',@fi=N'2022/02/01',@ff=N'2022/02/05',@proveedor=0
*/
GO