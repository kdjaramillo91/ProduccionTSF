/****** Object:  StoredProcedure [dbo].[spPar_LibrasLiquidadaspendientePagoAprobadoProveedor]    Script Date: 13/06/2023 03:50:35 p. m. ******/
SET ANSI_NULLS ON
GO
...
-- Query/ SP Original: par_ProductionPoundsliquidationPayPendient
CREATE OR ALTER procedure [dbo].[spPar_LibrasLiquidadaspendientePagoAprobadoProveedor]
@id varchar(50) = '',
@fi varchar(10) = '',
@ff varchar(10) = '',
@proveedor int = 0
...
/*
	EXEC spPar_LibrasLiquidadaspendientePagoAprobadoProveedor 
*/
