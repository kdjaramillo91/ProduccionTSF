/****** Object:  StoredProcedure [dbo].[par_ProductionPoundsliquidationProvPayPendApro]    Script Date: 28/02/2023 09:33:29 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE OR ALTER PROCEDURE [dbo].[spPar_LibrasLiquidadasPendientesPagoPAprobadoProveedor]
@id varchar(50) = '',
@fi varchar(10) = '',
@ff varchar(10) = '',
@proveedor int = 0
...
/*
	EXEC spPar_LibrasLiquidadasPendientesPagoPAprobadoProveedor '', '2022/03/01', '2022/04/30', 0
*/