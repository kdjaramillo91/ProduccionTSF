/****** Object:  StoredProcedure [dbo].[spPar_IngresoCamaronStatus]    Script Date: 15/06/2023 01:36:32 p. m. ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER   PROC [dbo].[spPar_IngresoCamaronStatus]
@id varchar(50) = '',
@fi varchar(10) = '',
@ff varchar(10) = '',
@proveedor int
...
and pl.id_ProductionLotState  not in (11)  --no anulado ni pendiente de recepción
order by PL_number


/*
	exec spPar_IngresoCamaronStatus @id=N'',@fi=N'2022/11/01',@ff=N'2022/11/30',@proveedor=0
*/
GO
